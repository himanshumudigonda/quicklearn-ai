...
// Use the environment variable, but fallback to Render backend URL
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://quicklearn-backend-vkk9.onrender.com';
